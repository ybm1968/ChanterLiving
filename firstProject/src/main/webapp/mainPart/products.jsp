...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css"
	...
	<link rel="stylesheet" href="../static/css/mainPart/products.css">
...
<body>
				...
				<div class="col-lg-6 mx-auto">
					...
					<div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
					    ...
					    <%
					  	...
					  	%>
						<!-- 유저일 때 -->
						<a href="../user/reservationList.jsp"
	            ...
	            <div class="card p-3">
	                ...
	                <div class="content">
	                    ...
	                    <p class="d-flex justify-content-end">
	                        <a href="./product.jsp?id=<%= product.getProduct_id() %>" class="btn btn-outline-dark for-hover">자세히 보기</a>
	                    </p>
	...
	<section id="sectionImg">
		...
		<div class="image-container">
			<div class="image-group">
			    <img alt="" src="mainPartImg/main1.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main2.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main3.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main4.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main5.svg" class="for-hover">
			</div>
			<div class="image-group">
			    <img alt="" src="mainPartImg/main6.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main7.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main8.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main9.svg" class="for-hover">
			    <img alt="" src="mainPartImg/main10.svg" class="for-hover">
			</div>
		</div>
	</section>
	...
	<section class="image-section">
		...
		<div id="asBtn">
			<a href="../subPart/AS_service.jsp" class="btn btn-lg btn-outline-secondary for-hover">A/S 절차가 궁금하다면?</a>
		</div>
	</section>
